...
parameters= {"lat":51.50735, 
        "lon":-0.127758,
        "appid": api_key, 
        "exclude": "current, minutely, daily"}

response = requests.get(OWM_path, params= parameters)
...
if will_rain:
    ...
    messages= client.messages.create(body="It is going to rain today.Remember to bring an umbrella.", 
                                    from_=+13342316855, 
                                    to=+251983777202)
